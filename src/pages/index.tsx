...
export default function Home() {
  return (
    <>
      ...
      <div className="flex flex-col just justify-center fixed inset-y-1/2">
        <h2 className="font-semibold">
          Hi, my name is Josh!
        </h2>
        <h5>
          I&apos;m a software developer at Rockport Networks and a student at the University of Windsor
        </h5>
